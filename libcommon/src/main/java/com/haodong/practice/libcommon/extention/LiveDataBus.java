package com.haodong.practice.libcommon.extention;
...
/**
 * created by linghaoDo on 2020/10/13
 * description:
 * <p>
 * version:
 */
...
//    }
    ...
    public static class Lazy {
        public static final LiveDataBus sLiveDataBus = new LiveDataBus();
    }
    ...
    /**
     * 事件的发送可以在子线程也可以在主线程，所以使用ConcurrentHashMap  保证数据的同步
     */
    ...
    public static class StickyLiveData<T> extends LiveData<T> {
        ...
        private int mVersion = 0;// 标记livedata 发送事件的总数
